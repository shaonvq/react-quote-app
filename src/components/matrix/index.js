...
export default class Matrix extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{...style, background: '#000000', width: this.props.fullscreen ? '100vw' : this.props.width + 'px', height:  this.props.fullscreen ? '250vh' : '150' + 'vh', overflow: 'hidden', zIndex: this.props.zIndex}}>
                <canvas ref='canvas'/>
            </div>
        );
    }
